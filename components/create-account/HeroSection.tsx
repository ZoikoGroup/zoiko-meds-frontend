        ...
        <div className="flex flex-col lg:flex-row md:gap-16 items-start">
          ...
          <div className="w-full lg:w-1/2 lg:max-w-md">
            <div className="bg-white border border-[#E2E8F0] rounded-2xl p-7 shadow-sm">
              ...
              {/* Primary CTA */}
              <button className="w-full bg-[#13A594] hover:bg-[#168b7e] active:bg-bg-[#168b7e] text-white font-semibold text-[15px] py-3 rounded-lg transition-colors duration-150 mb-4">
                Create Free Account
              </button>
              ...
              <div className="space-y-3 mb-5">
                {/* Passkey */}
                <button className="w-full flex items-center justify-center gap-2 border border-slate-300 rounded-lg py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-1 text-center text-sm text-[#0D1B2E] mb-5">
                <div className="flex items-center gap-1">
                  ...
                  <button className="font-medium text-[#13A594] hover:underline">
                    Sign In
                  </button>
                </div>
              ...
              <p className="text-[13px] text-[#566476] font-medium leading-relaxed pt-4 border-t border-t-[#E2E8F0]">
                ...
                access:{" "}
                <button className="text-[#13A594] font-medium hover:underline">Pharmacy access</button>
                {" · "}
                <button className="text-[#13A594] font-medium hover:underline">Enterprise</button>
                {" · "}
                <button className="text-[#13A594] font-medium hover:underline">Wholesale Portal</button>.
              </p>
            </div>
          </div>
